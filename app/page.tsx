  ...
  const timelineData = [
    {
      ...
      description: "Full-cycle development of web applications, Telegram bots, and internal services. Solo developer handling entire stack from architecture to DevOps.",
      details: [
        "Built intelligent search and data analysis system with custom relevance model and LLM integration (ChatGPT API)",
        "Developed analytics platform for text and behavioral data processing with custom NLP models",
        "Implemented RAG platform using Qdrant vector DB and LLM for intelligent search",
        "Established complete DevOps cycle: Linux server infrastructure, Docker containerization, CI/CD, monitoring with Nginx and Grafana",
      ],
      technologies: ["Python", "FastAPI", "Next.js", "Docker", "Linux", "Nginx", "Qdrant", "SpaCy", "Hugging Face", "OpenAI API", "Bitrix24", "Telegram API"],
      year: "2024-2025",
      website: "napateam.uz/en",
    },
    {
      title: "Starpets",
      role: "Software Developer",
      description: "Developed automated solutions for Roblox gameplay using computer vision, OCR, and voice AI. Collaborated in a team of 10 developers.",
      details: [
        "Developed CV and OCR solutions for game object and text recognition in Roblox, automating key gameplay processes",
        "Implemented AI-powered voice chat based on SIP/RTP and LLM models for real-time virtual assistant interactions",
        "Automated deployment and monitoring of services on Linux and Windows, integrated CI/CD and centralized logging",
        "Collaborated effectively in a team of 10 developers, implemented coding standards and improved project quality",
      ],
      technologies: ["Python", "FastAPI", "WebSockets", "SIP/RTP", "LLM", "OCR", "Computer Vision", "Selenium", "Docker", "Linux", "Windows"],
      year: "2023-2024",
      website: "starpets.gg",
    },
    {
